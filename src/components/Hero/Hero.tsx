...
const Hero = () => {
  ...
  return (
    ...
    >
      <img
        className="z-0 hidden md:block opacity-40 left-0 top-0 bottom-0 my-auto absolute h-[100vh] "
        src={imgLeft}
        alt=""
      />
      <img
        className="z-0 hidden md:block opacity-40 right-0 max-xl:-right-32 top-0 bottom-0 my-auto absolute h-[100vh] "
        src={imgRight}
        alt=""
      />
      <img
        className="z-0  opacity-30 md:opacity-50  right-0 left-0 top-0 bottom-0 m-auto absolute h-[100vh] "
        src={imgMid}
        alt=""
      />
      <Navbar />
