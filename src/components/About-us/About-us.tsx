...
const AboutUs = () => {
  return (
    ...
    <span className="sr-only">Loading...</span>
      ...
      <div className=''><HoverVideoPlayer loading="lazy" videoSrc= {vid2} /></div> 
      <div className=''><HoverVideoPlayer loading="lazy" videoSrc= {vid3} /></div> 
      <div className=''><HoverVideoPlayer loading="lazy" videoSrc= {vid4} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid5} /></div> 
      <div className='hidden sm:block '><HoverVideoPlayer loading="lazy" videoSrc= {vid6} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid7} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid8} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid9} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid10} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy" videoSrc= {vid11} /></div> 
      <div className='hidden sm:block'><HoverVideoPlayer loading="lazy"  videoSrc= {vid12} /></div> 
      </div>
    </div>
    </div>
  )
